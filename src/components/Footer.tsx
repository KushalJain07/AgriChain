        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-lg">AgriChain</span>
            </div>
            <p className="text-gray-400 mb-4">
              Blockchain-powered food traceability platform that connects all stakeholders from farm to fork.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Get the latest updates on food traceability and AgriChain.</p>
            <form className="flex">
              <input
                type="email"
                placeholder="Your email"
                className="px-4 py-2 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-agrichain-green w-full"
              />
              <button
                type="submit"
                className="bg-agrichain-green hover:bg-agrichain-green-dark text-white px-4 py-2 rounded-r-lg"
              >
                Subscribe
              </button>
            </form>
