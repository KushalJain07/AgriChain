  ...
  return (
    <section className="bg-gradient-to-br from-agrichain-green to-agrichain-green-dark text-white py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto bg-white/10 backdrop-blur-sm rounded-xl p-6 md:p-10 shadow-xl border border-white/20">
                    ...
                    {[
                      ...
                      <div key={index} className="flex">
                        <div className="mr-4 flex flex-col items-center">
                          <div className="bg-agrichain-green text-white w-8 h-8 rounded-full flex items-center justify-center">
                            {step.icon}
                          </div>
                          {index < 6 && <div className="w-0.5 h-full bg-gray-200 mt-1"></div>}
                        </div>
                        <div>
